HS <- function(application , request_id){
  ...
  #### Application details json converted to columns
    ...
    tenure <- 12
    #if(is.na(tenure)){
    #tenure <- gsub("[^0-9]","",model_decision_with_tier_row$MaxTenor)
    #}else{
    #  tenure <- min(as.numeric(data$loan_duration[1]) , as.numeric(gsub("[^0-9]","",model_decision_with_tier_row$MaxTenor) ))
     # print(data$loan_duration)
    #  print(tenure)
    #}
    #print(data$loan_duration)
